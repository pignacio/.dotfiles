...
" Class definitions
syn region  pythonClass start="^\s*class\s" end="\s*:" contains=pythonClassDef,pythonClassName,pythonSuperclasses
...
syn match   pythonDecorator	"@[a-zA-Z_][a-zA-Z0-9_]*" display nextgroup=pythonFunction skipwhite
